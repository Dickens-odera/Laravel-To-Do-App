...
@section('content')
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header bg-info text-white text-uppercase">{{ __('Update task') }}</div>
                <div class="card-body">
                        {!! Form::open(['action'=>['Tasks\TasksController@update','id'=>$task->id],'method'=>'post'])!!}
